...
def create_app(**kwargs: Any) -> FastAPI:
    ...
    personal_agent_service = kwargs.pop("personal_agent_web_service", None)
    if personal_agent_service is None:
        personal_agent_service = kwargs.pop("personal_agent_service", None)
    personal_agent_advisor = kwargs.pop("personal_agent_advisor", None)
    ...
    install_personal_agent_routes(
        app,
        service=personal_agent_service,
        planning_service=personal_planning_service,
        execution_service=execution_feedback_service,
        action_gateway_service=action_gateway_service,
        advisor=personal_agent_advisor,
        env_file=env_file,
        vault_path_override=vault_path_override,
    )
    install_action_gateway_routes(
