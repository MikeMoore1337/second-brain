...
с дефисами. Все пути относительны корню vault, используют `/` и не могут содержать
absolute path или сегменты `.`/`..`. Неизвестные поля дают warning, чтобы reader
мог пережить расширение контракта.
