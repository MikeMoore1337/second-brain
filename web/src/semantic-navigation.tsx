...
export const semanticGroups = [
  ...
  },
  {
    ...
    tools: [
      ...
      { id: "execution-feedback", label: "Выполнение и обратная связь", description: "Запиши фактическое выполнение принятого плана и сравни его с намерением.", target: "#execution-feedback", icon: "play", availability: "available", renderSurface: true },
