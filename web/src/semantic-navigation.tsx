...
export const semanticGroups = [
  ...
  },
  {
    ...
    tools: [
      ...
      { id: "personal-planning", label: "Личное планирование", description: "Собери портфель целей, вместимость и проверяемый план без автоисполнения.", target: "#personal-planning", icon: "personal-planning", availability: "available", renderSurface: true },
      { id: "execution-feedback", label: "Выполнение и обратная связь", description: "Запиши фактическое выполнение принятого плана и сравни его с намерением.", target: "#execution-feedback", icon: "execution-feedback", availability: "available", renderSurface: true },
