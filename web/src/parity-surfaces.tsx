...
function DraftReview({ response, onReset, allowPersonalMemory }: DraftReviewProps): ReactElement {
  ...
  async function handlePrepare(): Promise<void> {
    ...
    try {
      ...
      setStatus("Проверь полный список изменений и подтверди сохранение.");
    } catch (caught) {
