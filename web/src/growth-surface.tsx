          ...
          {growth ? (
            <section className="growth-panel" aria-labelledby="growth-result-title">
              ...
              <section className="growth-action-panel growth-advisor-panel" aria-labelledby="growth-advisor-title">
                ...
                <p>Советник получает только явно введённые данные и текущую точную цель. Данные развития, аудита прогноза, когнитивного двойника и памяти автоматически не передаются.</p>
