...
it("renders exactly four semantic directions and removes the old decorative cards", async () => {
  ...
  expect(semanticGroups.map((group) => group.tools.length)).toEqual([5, 4, 5, 3]);
  ...
  expect(rendered.querySelectorAll(".semantic-functional-surface")).toHaveLength(16);
  expect(rendered.querySelectorAll(".semantic-functional-surface[hidden]")).toHaveLength(16);
  expect(rendered.querySelectorAll(".semantic-functional-surface > details, .semantic-functional-surface > summary")).toHaveLength(0);
  expect(rendered.querySelectorAll(".semantic-functional-heading")).toHaveLength(16);
});
