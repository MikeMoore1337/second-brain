...
describe("React Web parity shell", () => {
  ...
  it("mounts every current-main GUI surface with the legacy Russian entry points", async () => {
    ...
    for (const id of ["decision-journal", "timeline", "self-model", "cognitive-twin", "simulate-me", "prospective-audit", "assistant-compare", "decision-compass", "retrospective-calibration", "self-retrieval", "active-learning", "diagnostics", "search", "capture", "growth-engine", "personal-strategy", "personal-planning", "execution-feedback", "personal-experiments"]) {
