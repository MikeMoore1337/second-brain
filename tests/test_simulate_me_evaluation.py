...
from second_brain.application.simulate_me import POLICY_FINGERPRINT
...
def test_evaluation_report_is_versioned_complete_and_green() -> None:
    ...
    assert payload["category_counts"] == [
        ...
        {"category": "abstention/no_matching_evidence", "count": 4},
        {"category": "abstention/multiple_options_supported", "count": 1},
    ...
    for case in _cases(payload):
        ...
        assert case["actual_policy_fingerprint"] == POLICY_FINGERPRINT
...
def test_evaluation_cli_renders_machine_and_human_reports(
    ...
    assert "| abstention/multiple_options_supported | 1 |" in markdown_output
